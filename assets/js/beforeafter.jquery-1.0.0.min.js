    ...
    return this.each(function () {
      !(function (t) {
        if (2 == jQuery(t).children().length) {
          ...
          var Q = document.createElement("wrapper-1");
          Q.setAttribute(
            "style",
            ""
          );
          var g = document.createElement("wrapper-2");
          g.setAttribute(
            "style",
            ""
          );
          var w = document.createElement("images-box");
          w.setAttribute(
            "style",
          ...
          var x = document.createElement("images-role");
          x.setAttribute(
            "style",
            "position:absolute !important;width:5px !important;height:100% !important;top:0px !important;right:" +
              o.position +
              "% !important;overflow:visible !important;transform:translateX(50%) !important;background-color: #000000;cursor:ew-resize;opacity:" +
              o.opacity +
              ";z-index:" +
              v +
              "2;" +
